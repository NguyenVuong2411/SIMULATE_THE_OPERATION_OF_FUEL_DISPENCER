...
// most of TCP/IP works without the next two lines, but not FSIO because
// they used 'int' and 'short int' way too many times.
#type signed
...
signed int8 memcmppgm2ram(void * s1, rom char *s2, unsigned int16 n);
